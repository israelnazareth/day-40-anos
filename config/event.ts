...
export const EVENT = {
  ...
  honoree: "Day Muniz",
  age: 40,
  date: "2026-10-02T20:00:00-03:00",
  ...
  whatsapp: "5521987086134",
  whatsappLabel: "+55 21 98708-6134",

  // Chave Pix
  pixKey: "5521987086134",

  // Nome do recebedor (máximo 25 caracteres)
  pixHolder: "Dayllane Cristina Muniz Nazareth",
...
export function giftWhatsappMessage(params: {
  ...
  return `Oi Day! Fiz o Pix de ${valor}${item} como presente pelos seus 40 anos. Segue o comprovante 💛`;
}
